...
def send_message():
    ...
    try:
        ...
        try:
            ...
            # Store the encrypted message and key in the database with initial status
            # Store the encrypted message in the database along with the original message
            cursor.execute('''
